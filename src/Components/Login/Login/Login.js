...
console.log(props.user);
    ...
    const handleAddUser = (event) => {
      ...
      //stara funkcija za random avatara, ostavit ću jer ne smeta
    ...
    return(
        <Card
          ...
          <form onSubmit={handleAddUser}>
              {/*<Avatar addAvatar={handleAddAvatar} /> */}
              <label>Unesite svoj nadimak</label>
              <input className="inputText"
              type='text'
              placeholder='Nadimak'
              onChange={handleUsernameChange}
              /> 
              <label>Odaberite svoj avatar</label>
              ...
              <input className="inputColor" type="color" onChange={handleColorChange} value={props.user.randomColor}></input>
              {/*mijenja username i boju sa svakom promjenom */}
              <label className="previewLabel">Ovako će izgledati Vaš profil</label>
              <img src={props.user.avatar} className="preview" style={{backgroundColor: props.user.randomColor}}></img>
